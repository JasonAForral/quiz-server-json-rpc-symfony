...
class ApiControllerTest extends WebTestCase
{
    ...
    public function testGetSessionInfoResponds()
    {
        $expected = [
            'id' => 1,
            'jsonrpc' => '2.0',
    ...
    public function testGetSessionInfoRespondsToNoSession()
    {
        $expected = [
            'id' => 1,
            'jsonrpc' => '2.0',
    ...
    public function testLoginLogsInCaseInsensitive()
    {
        $expected = [
            'id' => 1,
            'jsonrpc' => '2.0',
    ...
    public function testCreateAccountUserExistsCaseInsensitve()
    {
        $expected = [
            'id' => 1,
            'jsonrpc' => '2.0',
